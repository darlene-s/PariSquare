        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
                ...
                <div class="carousel-caption">
                    ...
                    <a class="btn btn-success px-5 py-2" href="index.php?controle=joueurController&action=jeuArrondissement"
                        role="button"> Jouer </a>
                </div>
            </div>
            <div class="carousel-item">
                ...
                <div class="carousel-caption">
                    <h3 class="h3-responsive mb-4"><mark>Discover Paris</mark></h3>
                     <a class="btn btn-success px-5 py-2" href="index.php?controle=joueurController&action=discoverparis"
            ...
            <div class="carousel-item">
                ...
                <div class="carousel-caption">
                    <h3 class="h3-responsive mb-4"><mark>Règles du jeu</mark></h3>
                      <a class="btn btn-success px-5 py-2" href="index.php?controle=joueurController&action=reglesJeuJoueur"
